...
const swaggerOptions = {
  swaggerDefinition: {
    ...
    info: {
      ...
      description:
        "Hi, my name is Mario Salazar, The next project is about users and Tasks (CRUD) and Login users.",
    ...
    paths: {
      "/api/sendemail": {
        post: {
          tags: ["email"],
          summary: "Sean a new message email ✅",
          description:
            "Send a message email using nodemailer",
      ...
      "/api/auth/register": {
        post: {
          ...
          description:
            "Register a new user to access, you need an email and password",
